    ...
    <>
      ...
      <div className='w-full h-full bg-[#C8E9F0]  flex flex-col justify-start fixed z-0 left-0'>
          ...
          <div className={'pl-[8vmax] font-roboto font-[400] w-[40%] mt-[8vmax]'}>
              ...
              <h1 className={'text-8xl gap-2 my-2 flex'}>A Day Off
                <img className='-mt-20' src='star.svg'/>
              </h1>
              <p className={'text-sm w-[70%] mt-[25%] font-light'}>We plan to help like-minded people connect, interact and learn, by exposing them to all things' technology through our amazing speaker lineup and activities.</p>
          </div>
      </div>
    </>
  )
